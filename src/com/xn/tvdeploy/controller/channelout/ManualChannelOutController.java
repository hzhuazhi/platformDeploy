...
import com.xn.common.util.ASCIISort;
...
import com.xn.tvdeploy.controller.manual.ManualController;
 ...
 **/
@Controller
@RequestMapping("/manualchannelout")
public class ManualChannelOutController extends BaseController {


    private static Logger log = Logger.getLogger(ManualChannelOutController.class);
    ...
    @RequestMapping("/list")
    public String list() {
        return "manager/manualchannelout/manualchanneloutAdd";
    }
