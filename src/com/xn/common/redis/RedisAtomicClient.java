...
import com.xn.common.util.UUIDUtils;
...
public class RedisAtomicClient {
    private static final Logger log = Logger.getLogger(RedisAtomicClient.class);

    //传入的redisTemplate不需要关心序列化方式，内部会自动使用其他序列化方式
    private final RedisTemplate redisTemplate;
    private final StringRedisTemplate stringRedisTemplate;

    private static ConcurrentMap<String, ReentrantLock> key2lockMap = new ConcurrentHashMap<>();
