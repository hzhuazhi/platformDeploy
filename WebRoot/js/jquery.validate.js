...
//判断由26个英文字母数字或下滑线 ^w+{5,21}$     验证密码 ^[a-zA-Z]w{5,17}$ 由字母开头6-18之间，只能包含字符、数字和下划线。


//判断由26个英文字母数字或下滑线 ^w+{5,21}$ 
jQuery.validator.addMethod("isAccountName", function(value, element) {    
	  var rule = /^\w{5,21}$/;       
   return this.optional(element) || (rule.test(value));    
}, "请输入6-20个有英文字母、数字或下划线组成的名称。");

//验证密码 ^[a-zA-Z]w{5,17}$ 由字母开头6-18之间，只能包含字符、数字和下划线。
jQuery.validator.addMethod("isPassword", function(value, element) {    
	  var rule = /^\w{5,17}$/;       
return this.optional(element) || (rule.test(value));    
}, "请输入字母开头6-18之间，只能包含字符、数字和下划线。");
