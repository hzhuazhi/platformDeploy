...
oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下一页",sPrevious:"前一页"},sEmptyTable:"No data available in table",sInfo:"显示 _TOTAL_ 条数据中的第 _START_ 至 _END_ 条",sInfoEmpty:"显示 0条",sInfoFiltered:"(从 _MAX_ 条数据中查询)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 条",sLoadingRecords:"加载中...",sProcessing:"运行中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"未找到符合条件的数据"},oSearch:i.extend({},l.models.oSearch),sAjaxDataProp:"aaData",
