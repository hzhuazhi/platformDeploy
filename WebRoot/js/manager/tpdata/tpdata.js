...
var account = {
    //地址
    url:{
        list_url : ctx + '/tpdata/list.do',
        dataList_url : ctx + "/tpdata/dataList.do",
        ...
        manyOperation_url: ctx+ "/tpdata/manyOperation.do",
        exportData_url : ctx +  "/tpdata/exportData.do"
    },
    //列表显示参数
    list:[
        {"data":"myTradeNo",},
