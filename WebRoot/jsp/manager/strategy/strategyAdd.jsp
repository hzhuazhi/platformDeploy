            ...
            <ul>
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="stgName" name="stgName"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="stgType" name="stgType"	maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="stgKey" name="stgKey"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="stgNumValue" name="stgNumValue"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="stgValue" name="stgValue"	maxlength="240" />
                    </div>
                </li>
