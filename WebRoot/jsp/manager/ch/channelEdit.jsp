...
<div class="col_main">
    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                <c:set var="dataModel" value="${channelModel}"/>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="channelName" name="channelName" value="${dataModel.channelName}" maxlength="240" />
                    </div>
                </li>

                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>渠道号</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="channelNum" name="channelNum" value="${dataModel.channelNum}" maxlength="240" />
                    </div>
                </li>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            messages: {
                ...
                channelName:{
                    required : "渠道号名称不能为空!",
                    maxlength : "渠道号名称长度最多是50个字符!"
                },
                channelNum:{
                    required:"渠道号不能为空!",
                    maxlength:"渠道号长度最多是30个字符!"
                },
            },
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("修改成功！");
                            window.location.href = ctx + "/ch/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
