            ...
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="moduleShowName" name="moduleShowName" value="${dataModel.moduleShowName}" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="moduleName" name="moduleName" value="${dataModel.moduleName}" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="moduleVer" name="moduleVer" value="${dataModel.moduleVer}" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <select id="moduleType" name="moduleType">
                            ...
                            <c:if test="${dataModel.moduleType == 1}">
                                <option value="1" selected="selected">任务管理器</option>
                                <option value="2">更新模块</option>
                                <option value="3">广告模块</option>
                                <option value="4">文件操作</option>
                                <option value="5">获取域名</option>
                            </c:if>
                            <c:if test="${dataModel.moduleType == 2}">
                                <option value="1">任务管理器</option>
                                <option value="2" selected="selected">更新模块</option>
                                <option value="3">广告模块</option>
                                <option value="4">文件操作</option>
                                <option value="5">获取域名</option>
                            </c:if>
                            <c:if test="${dataModel.moduleType == 3}">
                                <option value="1">任务管理器</option>
                                <option value="2">更新模块</option>
                                <option value="3" selected="selected">广告模块</option>
                                <option value="4">文件操作</option>
                                <option value="5">获取域名</option>
                            </c:if>
                            <c:if test="${dataModel.moduleType == 4}">
                                <option value="1">任务管理器</option>
                                <option value="2">更新模块</option>
                                <option value="3">广告模块</option>
                                <option value="4" selected="selected">文件操作</option>
                                <option value="5">获取域名</option>
                            </c:if>
                            <c:if test="${dataModel.moduleType == 5}">
                                <option value="1">任务管理器</option>
                                <option value="2">更新模块</option>
                                <option value="3">广告模块</option>
                                <option value="4">文件操作</option>
                                <option value="5" selected="selected">获取域名</option>
                            </c:if>
                        </select>
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        ...
                        <pre id="console"></pre>
                        <div class="formCtrlDiv">
                            应用下载地址：<input type="text" class="formInput" id="textFileUrl" name="moduleUrl"  value="${dataModel.moduleUrl}" maxlength="480" />
                        </div>
                        <div class="formCtrlDiv">
                            文件大小：<input type="text" class="formInput" id="textFileSize" name="fileSize" value="${dataModel.fileSize}" maxlength="480" />
                        </div>
                        <p>&nbsp;</p>
                    </div>
                </li>
