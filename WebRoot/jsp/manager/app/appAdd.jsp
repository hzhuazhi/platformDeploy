        ...
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="appName" name="appName" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="appNum" name="appNum" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="appVer" name="appVer" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="appPackage" name="appPackage" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="startBoundary" name="startBoundary" maxlength="240" />
                    </div>
                </li>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        ...
                        <pre id="console"></pre>
                        <div class="formCtrlDiv">
                            应用下载地址：<input type="text" class="formInput" id="textFileUrl" name="appUrl"  maxlength="480" />
                        </div>
                        <p>&nbsp;</p>
                    </div>
                </li>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            messages: {
                ...
                appNum:{
                    required:"应用编号不能为空!",
                    maxlength:"应用编号长度最多是20个字符!"
                },
                appVer:{
                    required:"应用版本号不能为空!",
                    maxlength:"应用版本号长度最多是20个字符!"
                },
                appPackage:{
                    required:"应用包名不能为空!",
                    maxlength:"应用包名长度最多是80个字符!"
                },
            },
