    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require"><font color="red">*</font>收益提成</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="royalty" name="royalty"	maxlength="500" />
                    </div>
                </li>
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/accountagent/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
